    ...
    return (
        <>
            <div className="home__data">
                <h1 className="home__title">Arthur Granito
                    <svg
                        width="36"
                        height="36"
                        viewBox="0 0 48 48"
                ...
                <p className="home__description">Sou programador front-end nascido em Petrópolis e sou muito dedicado e apaixonado ao meu trabalho.</p>
